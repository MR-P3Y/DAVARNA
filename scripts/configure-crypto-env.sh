...
upsert "$BACKEND_ENV" "CRYPTO_RATE_PROVIDER_THIRD" "tabdeal"
upsert "$BACKEND_ENV" "CRYPTO_RATE_PROVIDERS" "nobitex,wallex,tabdeal"
...
upsert "$BACKEND_ENV" "CRYPTO_TABDEAL_BASE_URL" "https://api1.tabdeal.org"
